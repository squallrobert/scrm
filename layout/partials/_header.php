<div class="modal fade" tabindex="-1" id="modal_planos">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">Créditos Sheephouse</h3>
            ...
            <div class="modal-body">
                <form name="fr-planos-credito" id="fr-planos-credito">
                        ...
                        <label class="nav-link btn btn-outline btn-outline-dashed btn-color-dark btn-active btn-active-primary d-flex flex-stack text-start p-6 mb-6 active" data-bs-toggle="tab" data-bs-target="#kt_upgrade_plan_startup" aria-selected="true" role="tab">
                            ...
                            <div class="d-flex align-items-center me-2">
                                ...
                                <div class="form-check form-check-custom form-check-solid form-check-success flex-shrink-0 me-6">
                                    <input class="form-check-input" type="radio" onclick="$('#pacote_custom').attr('disabled','disabled')" name="plano" id="plano_1" checked="checked" value="1">
                                </div>
                                <!--end::Radio-->
                                <!--begin::Info-->
                                <div class="flex-grow-1">
                                    <div class="d-flex align-items-center fs-2 fw-bold flex-wrap">Beginner</div>
<!--                                    <div class="fw-semibold opacity-75"></div>-->
                                </div>
                                <!--end::Info-->
                            </div>
                            <!--end::Description-->
                            ...
                            <div class="ms-5">
                                ...
                                <span class="fs-2x fw-bold" >80,00</span>
                            </div>
                            <!--end::Price-->
                        </label>
                        <!--end::Tab link-->
                        ...
                        <label class="nav-link btn btn-outline btn-outline-dashed btn-color-dark btn-active btn-active-primary d-flex flex-stack text-start p-6 mb-6" data-bs-toggle="tab" data-bs-target="#kt_upgrade_plan_advanced" aria-selected="false" role="tab" tabindex="-1">
                            ...
                            <div class="d-flex align-items-center me-2">
                                <!--begin::Radio-->
                                <div class="form-check form-check-custom form-check-solid form-check-success flex-shrink-0 me-6">
                                    <input class="form-check-input" type="radio" onclick="$('#pacote_custom').attr('disabled','disabled')" name="plano" id="plano_2" value="2">
                                </div>
                                <!--end::Radio-->
                                <!--begin::Info-->
                                <div class="flex-grow-1">
...
<!--                                    <div class="fw-semibold opacity-75">Best for 100+ team size</div>-->
                            ...
                            <div class="ms-5">
                                <span class="mb-2">R$</span>
                                <span class="fs-2x fw-bold" >250,00</span>
                            </div>
                            <!--end::Price-->
                        </label>
                        <!--end::Tab link-->
                        ...
                        <label class="nav-link btn btn-outline btn-outline-dashed btn-color-dark btn-active btn-active-primary d-flex flex-stack text-start p-6 mb-6" data-bs-toggle="tab" data-bs-target="#kt_upgrade_plan_enterprise" aria-selected="false" role="tab" tabindex="-1">
                            ...
                            <div class="d-flex align-items-center me-2">
                                <!--begin::Radio-->
                                <div class="form-check form-check-custom form-check-solid form-check-success flex-shrink-0 me-6">
                                    <input class="form-check-input" onclick="$('#pacote_custom').attr('disabled','disabled')" type="radio" name="plano" id="plano_3" value="3">
                                </div>
                                <!--end::Radio-->
                                <!--begin::Info-->
                                <div class="flex-grow-1">
                                    <div class="d-flex align-items-center fs-2 fw-bold flex-wrap">Enterprise
                                        <span class="badge badge-light-success ms-2 py-2 px-3 fs-7">Recomendado</span></div>
<!--                                    <div class="fw-semibold opacity-75">Best value for 1000+ team</div>-->
                            ...
                            <div class="ms-5">
                                <span class="mb-2">R$</span>
                                <span class="fs-2x fw-bold" >500,00</span>
                            </div>
                            <!--end::Price-->
                        </label>
                        <!--end::Tab link-->
                        ...
                        <label class="nav-link btn btn-outline btn-outline-dashed btn-color-dark btn-active btn-active-primary d-flex flex-stack text-start p-6 mb-6" data-bs-toggle="tab" data-bs-target="#kt_upgrade_plan_enterprise" aria-selected="false" role="tab" tabindex="-1">
                            ...
                            <div class="d-flex align-items-center me-2">
                                <!--begin::Radio-->
                                <div class="form-check form-check-custom form-check-solid form-check-success flex-shrink-0 me-6">
                                    <input class="form-check-input" onclick="$('#pacote_custom').removeAttr('disabled')" type="radio" name="plano" id="plano_4" value="4">
                                </div>
                                <!--end::Radio-->
                                <!--begin::Info-->
                                <div class="flex-grow-1">
                            ...
                            <!--begin::Price-->
                            <div class="ms-5">
                                <input name="pacote_custom" disabled inputmode="decimal" id="pacote_custom" value="" class="form-control">
                            </div>
                            <!--end::Price-->
                        </label>
                        <!--end::Tab link-->
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="bt_comprar_credito" class="btn btn-success">Ir para compra</button>
            </div>
        </div>
    </div>
</div>
                ...
                if($_SESSION['usuario']['id_forma_pagamento'] == 16)
                {
                    echo '
                          <div class="app-navbar-item ms-1 ms-md-3">
                           Saldo: &nbsp;<i class="fa fa-coins"></i>
                            <a href="#" data-bs-toggle="modal" data-bs-target="#modal_planos" id="saldo_topo" class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary h-30px w-md-100px h-md-40px" >
                               &nbsp;'.$_SESSION['usuario']['saldo'].'
                            </a>
                        </div>
                    ';
                }
                ...
                <div class="app-navbar-item ms-1 ms-md-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                        ...
                        if($_SESSION['usuario']['id_forma_pagamento'] == 16)
                        {
                            ?>
                            <div class="menu-item px-5">
                                <a href="javascript:;" onclick=" $('#modal_planos').modal('show');" class="menu-link px-5">Comprar Créditos</a>
                            </div>
                            <?
                        }
                        ?>
                        <!--begin::Menu item-->
                        <div class="menu-item px-5">
                            <a href="javascript:;" onclick="Squall.Descadastro()" class="menu-link px-5">Excluir conta</a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="menu-item px-5">
